...
if (!runIntegration) {
  console.warn(
    "Skipping drive_sync_state integration tests: set RUN_SUPABASE_TESTS=true and provide SUPABASE_URL and SUPABASE_DB_PASSWORD to enable",
  );
}

describe.skipIf(!runIntegration)("drive_sync_state integration", () => {
